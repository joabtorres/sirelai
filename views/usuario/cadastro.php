    ...
    <article class="clear" id="container-usuario-form">
        ...
        <form method="POST" enctype="multipart/form-data" autocomplete="off">
			...
			<div class="form-group <?php echo (isset($usuario_erro['nascimento']['class'])) ? $usuario_erro['nascimento']['class'] : ''; ?>">
                            ...
                            <input type="text" name="nNascimento" id="iNascimento" class="form-control input-data date_serach" placeholder="Exemplo: 15/08/2000" value='<?php echo isset($usuario['nascimento']) ? $this->formatDateView($usuario['nascimento']) : ""; ?>'/>
                        </div>
			...
			<div class="form-group">
				...
				<?php
				$array = array('Professor(a)', 'Aluno(a)', 'Usuário');
			...
			<div class="form-group" id="viewCurss">
				...
				<?php
				$array = array('Análise e Desenvolvimento de Sistemas', 'Ciências Biologica','Engenharia Agronoma','Técnico em Agroecologia', 'Técnico em Edificações', 'Técnico em Informática');
				for ($i = 0; $i < count($array); $i++) {
