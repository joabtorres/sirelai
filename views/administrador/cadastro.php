        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="alert <?php echo (isset($erro['class'])) ? $erro['class'] : 'alert-warning'; ?> " role="alert" id="alert-msg">
                    ...
                    <div id="resposta"><?php echo (isset($erro['msg'])) ? $erro['msg'] : ' <i class="fa fa-info-circle" aria-hidden="true"></i> Não é possível cadastrar um Administrador com e-email e matricula/Siape já cadastrado.'; ?></div>
                </div>
            </div>
        </div>
        <form method="POST" enctype="multipart/form-data" autocomplete="off">
            <section class="panel panel-black">
                <header class="panel-heading"><p class="panel-title"><i class="fa fa-user-plus"></i> Administrador</p></header>
			...
			<div class="form-group">
				...
				<?php
				$array = array('Coordenação de Curso de Tecnologia em Análise e Desenvolvimento de Sistemas (CTADS)', 'Coordernação de Curso Técnico em Informática (CTI)', 'Coordernação de Tecnologia de Informação e Comnicação (CTIC)');
